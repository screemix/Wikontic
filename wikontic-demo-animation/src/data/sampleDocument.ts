...
export const question = 'Какие системы объекта требуют контроля при эксплуатации?';

export const answer = 'Система мониторинга инженерных сетей требует контроля при эксплуатации объекта.';
