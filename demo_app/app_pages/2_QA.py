...
EXAMPLE_QUESTIONS = [
    "Есть ли конфликт интересов между Ветровым и Орехиным?",
    "Связана ли дейтельность Орехина с иностранными организациями",
    "Могут ли быть знакомы Орехин и Баранов?",
